...
const val ENV_LETS_PLOT_PLOT_THEME = "LETS_PLOT_PLOT_THEME"


internal object GlobalSettings {
    val isolatedFrameContext: Boolean get() = Env.getBool(ENV_HTML_ISOLATED_FRAME) ?: false

    var theme: OptionsMap? = Env.get(ENV_LETS_PLOT_PLOT_THEME)?.let { OptionsMap(THEME, parseJson(it).filterNonNullValues()) }
        set(value) {
