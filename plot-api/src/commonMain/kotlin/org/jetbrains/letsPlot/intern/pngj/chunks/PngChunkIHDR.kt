...
import org.jetbrains.letsPlot.intern.pngj.PngjInputException
 ...
 */
class PngChunkIHDR(info: ImageInfo?) : PngChunkSingle(ID, info) {
    var cols = 0
    var rows = 0
    ...
    override fun parseFromRaw(chunk: ChunkRaw) {
        ...
        val st: InputStream = chunk.asByteStream
