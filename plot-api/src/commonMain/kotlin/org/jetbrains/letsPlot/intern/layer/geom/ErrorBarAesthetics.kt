 ...
 * @property ymax Upper bound for the vertical error bar.
 * @property width Width of the whiskers of the vertical error bar. Typically ranges between 0 and 1.
 *  Values that are greater than 1 lead to overlapping of the bars.
 * @property y Y-axis coordinates for the horizontal error bar.
 * @property xmin Lower bound for the horizontal error bar.
 * @property xmax Upper bound for the horizontal error bar.
