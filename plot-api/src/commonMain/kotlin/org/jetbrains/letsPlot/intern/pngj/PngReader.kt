...
import org.jetbrains.letsPlot.intern.pngj.chunks.ChunkLoadBehaviour
import org.jetbrains.letsPlot.intern.pngj.chunks.ChunksList
import org.jetbrains.letsPlot.intern.pngj.chunks.PngChunk.Companion.ID_FCTL
import org.jetbrains.letsPlot.intern.pngj.chunks.PngChunk.Companion.ID_FDAT
import org.jetbrains.letsPlot.intern.pngj.chunks.PngChunkIDAT
import org.jetbrains.letsPlot.intern.pngj.chunks.PngMetadata
import org.jetbrains.letsPlot.intern.pngj.utils.Checksum
import org.jetbrains.letsPlot.intern.pngj.utils.InputStream
import org.jetbrains.letsPlot.intern.pngj.utils.Zip.adler32
import org.jetbrains.letsPlot.intern.pngj.utils.Zip.crc32
 ...
 * samples).
 */
open class PngReader @JvmOverloads constructor(inputStream: InputStream, shouldCloseStream: Boolean = true) {
    // checked)
    /**
