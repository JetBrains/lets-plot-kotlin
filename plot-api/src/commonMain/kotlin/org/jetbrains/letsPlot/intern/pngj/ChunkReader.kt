...
import org.jetbrains.letsPlot.intern.pngj.ChunkReader.ChunkReaderMode
 ...
 */
abstract class ChunkReader(clen: Int, id: String, offsetInPng: Long, mode: ChunkReaderMode?) : IBytesConsumer {
    /**
     * see [ChunkReaderMode]
     */
