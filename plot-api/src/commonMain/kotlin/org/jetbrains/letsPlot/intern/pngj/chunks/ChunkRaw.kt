...
import org.jetbrains.letsPlot.intern.pngj.PngjBadCrcException
import org.jetbrains.letsPlot.intern.pngj.PngjException
import org.jetbrains.letsPlot.intern.pngj.PngjOutputException
...
class ChunkRaw(
     ...
     */
    fun writeChunk(os: OutputStream) {
        writeChunkHeader(os)
        if (len > 0) {
    ...
    private fun writeChunkHeader(os: OutputStream) {
    ...
    private fun writeChunkCrc(os: OutputStream) {
