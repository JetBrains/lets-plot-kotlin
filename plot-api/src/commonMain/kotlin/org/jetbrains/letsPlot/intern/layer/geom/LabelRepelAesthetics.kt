 ...
 * @param pointStroke Point stroke width behind the label.
 * @param segmentColor Color of connecting segment from point to label.
 *  For more info see: [aesthetics.html#color-and-fill](https://lets-plot.org/kotlin/aesthetics.html#color-and-fill).
 * @param segmentSize Width of connecting segment from point to label.
