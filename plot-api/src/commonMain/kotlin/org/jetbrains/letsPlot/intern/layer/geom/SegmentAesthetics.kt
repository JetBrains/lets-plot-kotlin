 ...
 * @property sizeStart Offset from the segment start coordinate. Usually equal to the size of the point object from which the segment starts to avoid overlapping with it.
 * @property sizeEnd Offset from the segment end coordinate. Usually equal to the size of the point object from which the segment ends to avoid overlapping with it.
 * @property strokeStart Offset from the segment start coordinate. Usually equal to the stroke of the point object from which the segment starts to avoid overlapping with it.
 * @property strokeEnd Offset from the segment end coordinate. Usually equal to the stroke of the point object from which the segment ends to avoid overlapping with it.
 */
