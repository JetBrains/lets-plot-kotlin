...
import org.jetbrains.letsPlot.intern.pngj.chunks.ChunkHelper
 ...
 * idat deflate
 */
abstract class ChunkSeqReader @JvmOverloads constructor(
     ...
     */
    @JvmOverloads
    fun feedFromInputStream(`is`: InputStream, closeStream: Boolean = true) {
