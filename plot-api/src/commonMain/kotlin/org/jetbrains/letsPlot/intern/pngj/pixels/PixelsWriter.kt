...
import org.jetbrains.letsPlot.intern.pngj.*
import org.jetbrains.letsPlot.intern.pngj.utils.DEFLATER_DEFAULT_STRATEGY
...
abstract class PixelsWriter(
    ...
    fun setOs(datStream: OutputStream) {
        os = datStream
    }
