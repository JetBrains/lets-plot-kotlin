...
* Swing Apps:
  ...
  Support for plot _**default interactions**_ and custom toolbar component.

  For more details, see [Interactions demo](https://github.com/alshan/lets-plot-mini-apps/blob/main/jvm-swing-app/src/main/kotlin/InteractionsDemoMain.kt) in the "lets-plot-mini-apps" repository.
